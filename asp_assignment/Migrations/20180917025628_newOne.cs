        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkPhoneNumber = table.Column<string>(maxLength: 15, nullable: true),
                    HomePhoneNumber = table.Column<string>(maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(maxLength: 100, nullable: false),
                    MobilePhoneNumber = table.Column<string>(maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderSouvenirID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    SouvenirID = table.Column<int>(nullable: false),
                    OrderID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderSouvenir", x => x.OrderSouvenirID);
                    table.ForeignKey(
                        name: "FK_OrderSouvenir_Order_OrderID",
                        column: x => x.OrderID,
                        principalTable: "Order",
                        principalColumn: "OrderID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderSouvenir_Souvenir_SouvenirID",
                        column: x => x.SouvenirID,
                        principalTable: "Souvenir",
                        principalColumn: "SouvenirID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderSouvenir_OrderID",
                table: "OrderSouvenir",
                column: "OrderID");

            migrationBuilder.CreateIndex(
                name: "IX_OrderSouvenir_SouvenirID",
                table: "OrderSouvenir",
                column: "SouvenirID");
